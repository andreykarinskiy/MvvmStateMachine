...
namespace Shell.ViewModels.States
{
    ...
    public class RecordViewModelState : ShellViewModelState
    {
        public RecordViewModelState(IEventAggregator eventAggregator) : base(eventAggregator)
        {
        ...
        {
            ChangeState<PlayerViewModelState>();
        }
    }
}
